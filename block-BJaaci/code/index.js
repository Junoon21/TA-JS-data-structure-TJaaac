...
console.log(movies[0].actors[movies[0].actors[actors.length-1]]);
...
for(let movie of movies){
  console.log(movie.genres.length>1?movie.title:false)
}
for(let movie of movies){
  if(movie.genres>1){
    console.log(movie.title)
...
for(let movie of movies){
  console.log(movie.actors.length>1?movie.title:false)
}
// 29. Log the name of all the movies with exactly 3 actors
for(let movie of movies){
  console.log(movie.actors.length===3?movie.title:false)
}
